...
import { Briefcase, LogIn, Mail, Lock, Sparkles } from "lucide-react";
      ...
      <div className="max-w-md w-full">
        <div className="bg-card border border-border rounded-2xl shadow-2xl p-8 relative overflow-hidden">
          ...
          <div className="text-center mb-8 relative z-10">
            ...
            <h1 className="text-2xl font-bold text-foreground mb-2">Тавтай морил</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
            ...
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-2 ml-1 flex justify-between">
                <span>Нууц үг</span>
                <Link href="/forgot-password" title="Нууц үг сэргээх" className="text-accent text-xs hover:underline">Мартсан?</Link>
              </label>
              <div className="relative">
          ...
          <div className="mt-8 text-center text-sm relative z-10">
            ...
            <Link href="/signup-choice" className="text-accent font-bold hover:underline">
              Шинэ бүртгэл үүсгэх
            </Link>
          </div>
        </div>
